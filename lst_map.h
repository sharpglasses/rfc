...
extern struct lst_node *lstmp_search(struct lst_map *lstmp, u_int32_t key);
extern s_int32_t        lstmp_set(struct lst_map *lstmp, u_int32_t key, u_int32_t val);
void                    lstmp_erase(struct lst_map *lstmp, u_int32_t key);
extern s_int32_t        lstmp_traversal(struct lst_map *lstmp, void *input, void *output, s_int32_t (*callback)(u_int32_t i, struct lst_map *, struct lst_node*, void *, void *));
